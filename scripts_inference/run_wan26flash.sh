...
# ==============================================================================
# Wan2.6 Flash API 并行推理脚本 (目录对齐版)
# Usage: ./scripts_inference/run_wan26flash.sh <DATASET> <TEST_NAME> [MODEL] [N_PROC] [DATA_ROOT]
# Example: ./scripts_inference/run_wan26flash.sh open_x_embodiment wan26_flash "wan2.6-i2v-flash" 4
# ==============================================================================

# --- 1. 参数获取与默认值 ---
DATASET=${1:-"debug"}
TEST_NAME=${2:-"wan26_flash"}
MODEL=${3:-"wan2.6-i2v-flash"}
N_PROC=${4:-4}
DATA_ROOT=${5:-"./data"}
DURATION=${6:-5}  # 视频时长默认 10s
N_ATTEMPTS=${7:-1} # 每个视频的重试次数，默认 3 次
# 你的 API KEY
API_KEY=""
...
# --- 4. 执行信息打印 ---
echo "------------------------------------------------"
echo "🚀 Starting Wan2.6 Flash API inference"
